...
saturnd: $(BUILD_DIR)/saturnd.o  $(BUILD_DIR)/daemon.o $(BUILD_DIR)/utils/read_requests.o $(BUILD_DIR)/utils/send_responses.o $(BUILD_DIR)/utils/command_line.o $(BUILD_DIR)/utils/custom_string.o $(BUILD_DIR)/tasks.o
	$(CC) $(CFLAGS) -o $@ $^
